...
export const getThreeDigitNumber = (number) => {
  ...
  if (number % 100 === 0) {
    ...
    return `${getOneDigitNumber(
      parseInt(hundred)
    )} hundred and ${getTwoDigitNumber(number - parseInt(hundred * 100))}`;
  }
};
...
export const getFourDigitNumber = (number) => {
  ...
  if (number % 1000 === 0) {
    ...
    return `${getOneDigitNumber(
      parseInt(thousand)
    )} thousand ${getThreeDigitNumber(number - parseInt(thousand * 1000))}`;
  }
};
...
export const getSevenDigitNumber = (number) => {
  ...
  if (number % 1000000 === 0) {
    ...
    return `${getOneDigitNumber(parseInt(million))} million ${getSixDigitNumber(
      tousend
    )}`;
  }
};
